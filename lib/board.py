...
# -*- coding: utf-8 -*-
"""
Created on Sun Oct 18 00:13:18 2020
...
class board:
    ...
    def playturn(self):
        ...
        new_pos = int(self.checkNewPosition(new_pos))
        # PENDING
        ...
        # print(newState)
        # analytics
        self.statPositions["q_visits"].iloc[new_pos] = self.statPositions["q_visits"].iloc[new_pos] + 1 